  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <div className="flex-1 flex flex-col px-5">
        {/* 상단 텍스트 */}
        <div className="w-full max-w-md mx-auto text-center mt-[116px]">
        ...
        {/* 카드 슬라이더 */}
        <div className="card-slider-container my-10 w-full max-w-md mx-auto">
        ...
        {/* 버튼 섹션 */}
        <div className="w-full max-w-md mx-auto mt-auto space-y-3 pb-10">
          <button
